...
.method public static newInstance(Lcom/google/android/libraries/places/api/model/Place;D)Lcom/google/android/libraries/places/api/model/PlaceLikelihood;
    ...
    invoke-static {v2, v5}, Lcom/google/common/collect/Range;->closed(Ljava/lang/Comparable;Ljava/lang/Comparable;)Lcom/google/common/collect/Range;
    ...
    invoke-virtual {v2, v5}, Lcom/google/common/collect/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v2

    const-string v5, "Likelihood must be within the range: %s to %s, but was: %s."
    ...
    .line 7
    invoke-static {v2, v5, v0, v1, v3}, Lcom/google/common/base/Preconditions;->checkArgument(ZLjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    .line 8
    new-instance v0, Lcom/google/android/libraries/places/internal/cj;

    invoke-direct {v0, p0, p1, p2}, Lcom/google/android/libraries/places/internal/cj;-><init>(Lcom/google/android/libraries/places/api/model/Place;D)V
